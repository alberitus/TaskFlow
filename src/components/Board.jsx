...
export default function Board({
    tasks, columns, onAdd, onDelete, onMove, onReorder,
    onAddColumn, onDeleteColumn, onReorderColumns, darkMode,
}) {
    ...
    return (
        ...
        >
                        ...
                        <form className="add-column-form" onSubmit={handleAddColumn}>
                            ...
                            <div className="color-presets">
                                ...
                                <button
                                    key={c}
                                    type="button"
                                    className={`color-dot ${newColColor === c ? "active" : ""}`}
                                    style={{ background: c }}
                                ...
                                <label className="color-picker-label" title="Custom color">
                                    ...
                                    />
                                    <span className="color-picker-icon" style={{ borderColor: newColColor, color: newColColor }}>
                                        ✏️
                                    </span>
                                </label>
                            </div>
            ...
            <DragOverlay>
                {activeTask && <TaskCard task={activeTask} onDelete={() => {}} darkMode={darkMode} />}
                {activeColumn && (
